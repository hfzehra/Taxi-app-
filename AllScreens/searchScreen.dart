...
class _SearchScreenState extends State<SearchScreen> {
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      Center(
                        child: Text("Konum arayınız...",style: TextStyle(fontSize: 18.0,fontFamily:"Brand-Bold" ),),
                      )
                    ],
                  ),
  ...
  void findPlace (String placeName) async //Yer ararken aranan yerleri ülke içine indirgeme
  {
